...
class ProfileUpdateForm(forms.ModelForm):
    ...
    class Meta:
        model = Profile
        fields = ['shake_to_logout', 'hide_logo', 'phone_number', 'enable_facial_recognition_bypass', 'enable_biometrics', 'image', 'cover_image', 'bio', 'subscribed', 'status', 'wishlist', 'shop_url', 'preferred_name', 'name']
        labels = {
