...
ALLOWED_HOSTS = [DOMAIN, STATIC_DOMAIN]
...
# Site descriotionn
BASE_DESCRIPTION = 'Entertainment, photos, videos, audio, and livestreaming, as well as ID Scanning and Web Development services.'
...
CRYPTO_CURRENCIES = ['BTC','ETH','LTC','ADA','LINK','USDT','USDC','MATIC','XRP','SOL','TRB','DOGE']
DEFAULT_CRYPTO = 'BTC'
