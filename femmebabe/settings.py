"""
Django settings for femmebabe project.
...
# Build paths inside the project like this: BASE_DIR / 'sufemmebabeir'.
...
MIDDLEWARE = [
    ...
    'payments.middleware.payments_middleware',
    'barcode.middleware.barcode_middleware',
...
WSGI_APPLICATION = 'femmebabe.wsgi.application'
...
# Site descriotionn
BASE_DESCRIPTION = 'Beauty and fashion at your fingertips, as well as ID Scanning and Web Development services.'
...
ASGI_APPLICATION = "femmebabe.routing.application" #routing.py will be created later
CHANNEL_LAYERS = {
    'default': {
...
CRYPTO_CURRENCIES = ['BTC','ETH','LTC','DOGE','ADA','LINK','USDT','USDC','MATIC','XRP','SOL']
DEFAULT_CRYPTO = 'BTC'
...
NFC_SCAN_REQUIRED_MINUTES = 60 * 6
...
NEW_USERS_PER_DAY = 12

# Pricing
from .pricing import get_pricing_options
TIP_OPTIONS = get_pricing_options(10)
...
STATIC_SITE_URL = 'https://glamgirlx.com'
