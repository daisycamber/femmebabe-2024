...
websocket_urlpatterns = [
    ...
    path('ws/remote/<str:uuid>/', remote_consumers.RemoteConsumer.as_asgi()),
    ...
    path('ws/chat/<str:username>/', chat_consumers.ChatConsumer.as_asgi()),
    path('ws/chat/<str:username>/video/', video_consumers.VideoConsumer.as_asgi()),
