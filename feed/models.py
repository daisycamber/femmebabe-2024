...
#        if self.image_thumb_offsite and self.public and not get_current_request().user.is_authenticated if get_current_request() else False: return self.image_thumb_offsite
...
#        if self.image_offsite and not get_current_request().user.is_authenticated if get_current_request() else False: return self.image_offsite
...
#        if self.image_thumb_offsite and not get_current_request().user.is_authenticated if get_current_request() else False: return self.image_thumb_offsite
